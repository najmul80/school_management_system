        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col">
                            <form method="post" action="{{route('fee.amount.update',$feeAmount[0]->fee_category_id)}}">
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                                        <div class="add_item">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <select name="fee_category_id" class="form-control" required>
                                                        ...
                                                        <option value="{{$feeCat->id}}" {{ ($feeAmount['0']->fee_category_id == $feeCat->id) ? "selected" : '' }}>{{$feeCat->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-row">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="controls">
                                                                <select name="class_id[]" class="form-control">
                                                                    ...
                                                                    <option value="{{$class->id}}" {{ ($amount->class_id == $class->id) ? 'selected' : ''}}>{{$class->name}}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-md-5">
                                                        <div class="form-group">
                                                            <h5> Amount </h5>
                                                            <div class="controls">
                                                                <input type="number" name="amount[]" class="form-control" value="{{$amount->amount}}" placeholder="Enter fee amount name" required>
                                                            </div>
                                                        </div>
                                                    </div>
